    ...
    return (
        <div>
            <main className="bg-[#EDEEF3] bg-[center_18rem] h-screen overflow-hidden flex flex-col justify-center items-center" style={{
                ...
                <a href="https://www.instagram.com/petrolida.2023/" className="absolute bottom-36 flex bg-[#07003F] rounded-full px-8 md:px-12 py-4 transition duration-300 hover:-translate-y-2" target="_blank">
                    <span className="pr-3">
