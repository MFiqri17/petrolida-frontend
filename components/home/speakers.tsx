      ...
      >
        ...
        <div className="flex items-center justify-center transition duration-300 bg-white cursor-pointer lg:-skew-x-12 h-fit w-fit lg:-rotate-12 rounded-xl hover:rotate-0 hover:skew-x-0">
          <blockquote
            ...
            data-instgrm-permalink={`https://www.instagram.com/reel/Co6eEkFMxf3/?utm_source=ig_web_copy_link`}
          ...
          >
            <div style={{ padding: 16 }}>
              {" "}
              <a
                href={`https://www.instagram.com/reel/Co6eEkFMxf3/?utm_source=ig_web_copy_link`}
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
        ...
        <div className="flex items-center justify-center bg-white cursor-pointer lg:-translate-y-10 h-fit w-fit rounded-xl">
          <blockquote
            className="instagram-media"
            data-instgrm-permalink={`https://www.instagram.com/reel/Co4jU4wNI6-/?utm_source=ig_web_copy_link`}
            data-instgrm-version={14}
            style={{
              background: "#FFF",
              border: 0,
          ...
          >
            <div style={{ padding: 16 }}>
              {" "}
              <a
                href={`https://www.instagram.com/reel/Co4jU4wNI6-/?utm_source=ig_web_copy_link`}
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
        ...
        <div className="flex items-center justify-center transition duration-300 bg-white cursor-pointer lg:skew-x-12 h-fit w-fit lg:rotate-12 rounded-xl hover:rotate-0 hover:skew-x-0">
          <blockquote
            className="instagram-media"
            data-instgrm-permalink={`https://www.instagram.com/p/Cozm6kzytXn/?utm_source=ig_web_copy_link`}
            data-instgrm-version={14}
            style={{
              background: "#FFF",
              border: 0,
          ...
          >
            <div style={{ padding: 16 }}>
              {" "}
              <a
                href={`https://www.instagram.com/p/Cozm6kzytXn/?utm_source=ig_web_copy_link`}
                style={{
                  background: "#FFFFFF",
                  lineHeight: 0,
                  padding: "0 0",
