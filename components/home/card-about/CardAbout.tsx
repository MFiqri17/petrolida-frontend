...
const CardAbout = ({ image, text, desc }: cardaboutInterface) => {
  return (
    <div
      className={`relative mx-auto flex flex-col items-center justify-center overflow-hidden px-4 pt-[200px] pb-[350px] md:flex-row md:space-x-8 md:px-10 lg:py-[350px] xl:pl-[222px] xl:pr-[120px]`}
    >
      <div
