    ...
    <>
      <div className=" ">
        <div className="container mx-auto flex justify-center">
          <ol className="mx-12 flex h-56 max-w-screen-xl snap-x items-center overflow-x-auto">
            {formType.map((item) => (
              <li
              ...
              >
                {item == 'General' ? (
                  ...
                  <>
                    ...
                    >
                      <div
                        className={`z-10 mx-auto flex h-8 w-8 items-center justify-center rounded-full ${
                          isActive == formType.indexOf(item)
                            ? 'bg-[#3D4BE0] outline outline-8 outline-[#838CEB] ring-8 ring-[#D0D4F8] ring-offset-8'
                            : isActive > formType.indexOf(item)
                            ? 'bg-[#838CEB] bg-gradient-to-r outline outline-[7px] outline-[#D0D4F8] ring-[7px] ring-inset ring-[#838CEB]'
